...
class E3CNN_Encoder(nn.Module):
    ...
    def __init__(self, input_chans, output_chans, n_levels, k, last_activation=None, return_fmaps=False, equivariance='O3'):
        ...
        self.net = e3cnn.ConvNet(f'{input_chans}x0e',f'{output_chans}x1e + {output_chans*2}x1o',k,k,(1,1,1),n_downsample=n_levels,equivariance=equivariance, lmax=4, return_fmaps=self.return_fmaps) 
